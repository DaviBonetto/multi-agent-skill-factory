...
# Or use .env file
_echo "HF_TOKEN=your_token_here" > .env
```
...
Em caso de erros de conexão, verifique sua conexão de internet e tente novamente.
...
Em caso de erros de permissão, verifique se você tem permissão para acessar o repositório e tente novamente.

```bash
# Verifique suas permissões
git ls-remote --heads https://github.com/username/model.git
...
Em caso de erros de formatação, verifique se o arquivo de configuração está correto e tente novamente.
