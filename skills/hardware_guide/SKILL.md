...
*   Utilize LoRA/PEFT para reduzir os requisitos de memória.
*   Ajuste o tamanho do batch e o número de etapas de acumulação de gradientes para evitar erros de memória.
...
