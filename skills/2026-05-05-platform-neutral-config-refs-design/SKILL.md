...
1. **`skills/writing-skills/SKILL.md:58`** — `Project-specific conventions (put in your instructions file)`
2. **`skills/receiving-code-review/SKILL.md:30`** — "You're absolutely right!" (explicit instruction-file violation)
## Out of scope
...
### Erros de sintaxe
- Verificar se as substituições de texto não introduzem erros de sintaxe nos arquivos afetados.
- Utilizar ferramentas de análise de sintaxe para garantir a integridade dos arquivos após as substituições.
### Referências circulares
- Verificar se as substituições criam referências circulares entre os arquivos.
- Utilizar ferramentas de análise de dependência para garantir que as referências sejam resolvidas corretamente.
### Arquivos não encontrados
- Verificar se os arquivos mencionados nas substituições existem e estão acessíveis.
- Utilizar ferramentas de gerenciamento de arquivos para garantir que os arquivos sejam encontrados e processados corretamente.
### Compatibilidade com plataformas
- Verificar se as substituições são compatíveis com todas as plataformas suportadas.
- Utilizar ferramentas de teste de compatibilidade para garantir que as substituições sejam válidas em todas as plataformas.
### Segurança
- Verificar se as substituições não introduzem vulnerabilidades de segurança nos arquivos afetados.
- Utilizar ferramentas de análise de segurança para garantir que as substituições sejam seguras e não explorem vulnerabilidades conhecidas.