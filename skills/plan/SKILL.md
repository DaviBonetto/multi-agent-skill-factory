...
- Adicionar tratamento de erros para casos de saída inválida (por exemplo, impossível gerar a imagem, etc.)
- Adicionar testes para garantir que os erros sejam tratados corretamente
- Considerar edge cases como:
  - Tamanho muito grande ou muito pequeno
  - Profundidade muito grande ou muito pequena
  - Iterações muito grandes ou muito pequenas
  - Caracteres inválidos ou não suportados

**Verify:**
- O programa lida corretamente com entradas inválidas e edge cases
- Os erros são tratados e mensagens de erro claras são exibidas
- Os testes passam e garantem a robustez do programa