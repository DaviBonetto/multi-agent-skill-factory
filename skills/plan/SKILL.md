...
**Do:**
- Adicionar tratamento de erros para casos de entrada inválida (por exemplo, tamanho negativo, profundidade negativa, etc.)
- Adicionar tratamento de erros para casos de saída inválida (por exemplo, tamanho de saída maior que o tamanho máximo permitido, etc.)
- Adicionar testes para casos de erro e edge cases
- Verificar se o programa lida corretamente com casos de erro e edge cases

**Verify:**
- O programa lida corretamente com casos de erro e edge cases
- Os testes para casos de erro e edge cases passam com sucesso

Exemplos de edge cases a considerar:

* Tamanho de entrada muito grande
* Profundidade de entrada muito grande
* Tamanho de saída muito grande
* Iterações muito altas
