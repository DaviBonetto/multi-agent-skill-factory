...
**Do:**
- Implemente tratamento de exceções para erros de entrada/saída
- Adicione verificações para edge cases, como:
...
*   Adição de testes para esses casos:
...
func TestGenerate(t *testing.T) {
    ...
    tests := []struct {
        ...
        {"valid input", 10, 5, nil},
        {"tamanho de entrada muito grande", 1000000, 5, nil},
        {"profundidade de recursão muito grande", 10, 1000000, nil},
    }
    for _, tt := range tests {
        t.Run(tt.name, func(t *testing.T) {
            got := Generate(tt.size, tt.depth, '*')
