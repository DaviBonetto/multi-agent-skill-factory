...
- Adicionar tratamento de erros para casos de saída inválida (por exemplo, arquivo de saída não encontrado, etc.)
- Adicionar testes para casos de edge (por exemplo, tamanho mínimo, profundidade mínima, etc.)
- Verificar se o programa lida corretamente com casos de entrada extremos (por exemplo, tamanho muito grande, profundidade muito grande, etc.)

**Verify:**
- O programa lida corretamente com casos de entrada inválida e edge cases
- O programa retorna mensagens de erro claras e úteis para casos de entrada inválida
- O programa passa em todos os testes, incluindo os testes de edge cases